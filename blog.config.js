...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小懒人', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '公众号「懒人找资源」作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lazybook.fun/#/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小懒人, 收藏夹', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 澳ICP备个蛋的案', // 备案号 闽ICP备XXXXXXX
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,messenger', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'f1ad72c6b4c783b2406ab92a5d5275fe', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
